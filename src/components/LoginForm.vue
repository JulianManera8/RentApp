        ...
        <form>
            ...
            <div class="btn-container">
                ...
                <div class="btn-container-social">
                    <button class="btn-social-item" value="google" name="provider"  type="submit" @click.prevent="signInGoogle"> <img src="../assets/icons/google.png" alt="google"> Continue with Google </button>
                    <button class="btn-social-item" value="facebook" name="provider"  type="submit" @click.prevent="signInFacebook"><img src="../assets/icons/facebook.png" alt="facebook"> Continue with Facebook</button> 
                </div>
  
            </div>

            <router-link to="/register"> <p>New here? <b>Create an account </b></p> </router-link>
        </form>
    </div>
</template>
...
const signIn = async () => {
  ...
  try {
    console.log(data)
    //ACA USAR VUE ROUTER CON ROUTE.PUSH O ALGO ASI
